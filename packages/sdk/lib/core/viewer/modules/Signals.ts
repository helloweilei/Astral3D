...
export class Signals {
	...
	cameraChanged() {
		this.viewer.pathtracer?.reset();
		const viewer = this.viewer as unknown as { toggleSubGridByCameraDistance: () => void };
		if (typeof viewer.toggleSubGridByCameraDistance === "function") {
			viewer.toggleSubGridByCameraDistance();
		}
		this.render();
	}
